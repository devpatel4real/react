...
// const heading = React.createElement("h1", { id: "heading" }, "Hello Dev Patel");

// JSX (transpiled before it reaches the JS) - Parcel - Babel
// const jsxHeading = <h1 id="heading">Devx </h1>;

// React Components
// const Heading = () => <h1>This text is comes from react Components</h1>;

// const Heading2 = () => {
//   return (
//     <>
//       <Heading />
//       <h3>this is react 2nd Components</h3>
//     </>
//   );
// };
  ...
  return (
    <div className="mx-10 my-10">
      ...
      <div className="flex flex-wrap space-x-4 space-y-4  justify-center">
        {datas.map((item) => (
          <ResCard
            className="space-x-[20px] space-y-[20px]"
            key={item.data.id}
            resdata={item}
          />
        ))}
